...
// const renderedCars = users.map((element) => {
//     return `
//     <div class="col-lg-4">
//                 <div class="card" style="width: 18rem;">
//                     <img src="${element.avatar_url}">
//                     <div class="card-body">
//                         <h5 class="card-title">${element.node_id}</h5>

//                         <a href="${element.url}">link to gitHab</a>
//                         <span>Quantity: ${element.idy}</span>
//                     </div>
//                 </div>
//     </div>
//     `
...
const element = [true, false, true, true, false, false, true];
